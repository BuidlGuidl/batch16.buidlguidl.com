...
const Index = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#385184] to-white dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4 text-black dark:text-white">
      <BuilderProfile
