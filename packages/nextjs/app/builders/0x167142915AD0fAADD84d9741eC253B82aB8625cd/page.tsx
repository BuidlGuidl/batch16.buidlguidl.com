...
const socialLinks = {
  github: "nnennaokoye",
  twitter: "_0xNina",
  linkedin: "nnennaokoye",
  instagram: "_ninacodes",
};

export default function BuilderPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-10 bg-base-100">
      <div className="card w-96 bg-base-200 shadow-xl">
        <figure className="px-10 pt-10">
          <Image
            src="https://avatars.githubusercontent.com/u/nnennaokoye"
            alt="Avatar"
            width={128}
            height={128}
        ...
        <div className="card-body items-center text-center">
          <h2 className="card-title text-2xl font-bold mb-2">Nnenna Okoye</h2>
          ...
          <div className="mb-6">
            <div className="badge badge-primary">Solidity</div>
            <div className="badge badge-secondary ml-2">TypeScript</div>
            <div className="badge badge-accent ml-2">Next.js</div>
            <div className="badge badge-accent ml-2">React</div>
            <div className="badge badge-primary ml-2">Hardhat</div>
            <div className="badge badge-secondary ml-2">Ethers.js</div>
          </div>
